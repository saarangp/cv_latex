...
\begin{projectlong}{EEG Foundation Model}{2024--Present}
    ...
    \item Contributed to an cross-dataset evaluation suite covering transfer, robustness to channel mismatch, and low-label adaptation across research and clinical tasks.
\end{projectlong}
